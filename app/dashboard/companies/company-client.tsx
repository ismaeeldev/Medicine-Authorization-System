...
export function CompanyClient() {
    ...
    return (
        <div className="grid gap-6 grid-cols-1 md:grid-cols-[1fr_2fr] lg:grid-cols-[350px_1fr] items-start">
            {/* Add Company Form */}
            ...
            <Card className="bg-white/5 backdrop-blur-xl border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
                ...
                <CardContent className="p-0 sm:p-6">
                    <div className="overflow-x-auto w-full">
                        <div className="min-w-[600px] rounded-md border border-white/10 overflow-hidden m-4 sm:m-0">
                            <Table>
